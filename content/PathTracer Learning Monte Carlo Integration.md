...
treeTitle: Game Development - Path Tracing - Monte Carlo Integration
---

tags:: concept, math, probability, monte-carlo
title:: PathTracer Learning Monte Carlo Integration
...
- ---
- ## Variance Reduction
	- [[PathTracer Learning Importance Sampling]] — sample where integrand is large
