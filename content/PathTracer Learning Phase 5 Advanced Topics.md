...
treeTitle: Game Development - Path Tracing - Phase 5 Advanced Topics
---
...
- ---
- ## Phase 5 Checklist
	- TODO Implement temporal accumulation with motion vector reprojection
	- TODO Implement temporal rejection (discard stale samples)
	- TODO Integrate OIDN or implement a simple spatial denoiser (SVGF)
	- TODO Implement MIS for NEE + BRDF sampling
	- TODO Implement demodulation (separate albedo from lighting for denoiser)
	- TODO Study ReSTIR DI paper and implement basic version
	- TODO Understand DLSS 3.5 Ray Reconstruction API
	- TODO Implement HDR tone mapping (ACES or AgX)
	- TODO Implement basic volumetric fog with delta tracking
- ---
- ## Navigation
